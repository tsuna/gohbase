...
const file_Client_proto_rawDesc = "" +
	...
	".pb.ResultR\x06result\"\x89\x02\n" +
	"\tCondition\x12\x10\n" +
	"\x03row\x18\x01 \x02(\fR\x03row\x12\x16\n" +
	"\x06family\x18\x02 \x01(\fR\x06family\x12\x1c\n" +
	"\tqualifier\x18\x03 \x01(\fR\tqualifier\x122\n" +
	"\fcompare_type\x18\x04 \x01(\x0e2\x0f.pb.CompareTypeR\vcompareType\x12.\n" +
	"\n" +
	"comparator\x18\x05 \x01(\v2\x0e.pb.ComparatorR\n" +
	"comparator\x12,\n" +
	"\n" +
	"time_range\x18\x06 \x01(\v2\r.pb.TimeRangeR\ttimeRange\x12\"\n" +
	"\x06filter\x18\a \x01(\v2\n" +
	".pb.FilterR\x06filter\"\xf8\a\n" +
...
var file_Client_proto_depIdxs = []int32{
	...
	38, // 12: pb.Condition.time_range:type_name -> pb.TimeRange
	37, // 13: pb.Condition.filter:type_name -> pb.Filter
	2,  // 14: pb.MutationProto.mutate_type:type_name -> pb.MutationProto.MutationType
	33, // 15: pb.MutationProto.column_value:type_name -> pb.MutationProto.ColumnValue
	36, // 16: pb.MutationProto.attribute:type_name -> pb.NameBytesPair
	1,  // 17: pb.MutationProto.durability:type_name -> pb.MutationProto.Durability
	38, // 18: pb.MutationProto.time_range:type_name -> pb.TimeRange
	41, // 19: pb.MutateRequest.region:type_name -> pb.RegionSpecifier
	12, // 20: pb.MutateRequest.mutation:type_name -> pb.MutationProto
	11, // 21: pb.MutateRequest.condition:type_name -> pb.Condition
	8,  // 22: pb.MutateResponse.result:type_name -> pb.Result
	6,  // 23: pb.Scan.column:type_name -> pb.Column
	36, // 24: pb.Scan.attribute:type_name -> pb.NameBytesPair
	37, // 25: pb.Scan.filter:type_name -> pb.Filter
	38, // 26: pb.Scan.time_range:type_name -> pb.TimeRange
	0,  // 27: pb.Scan.consistency:type_name -> pb.Consistency
	39, // 28: pb.Scan.cf_time_range:type_name -> pb.ColumnFamilyTimeRange
	41, // 29: pb.ScanRequest.region:type_name -> pb.RegionSpecifier
	15, // 30: pb.ScanRequest.scan:type_name -> pb.Scan
	8,  // 31: pb.ScanResponse.results:type_name -> pb.Result
	18, // 32: pb.ScanResponse.scan_metrics:type_name -> pb.ScanMetrics
	44, // 33: pb.ScanMetrics.metrics:type_name -> pb.NameInt64Pair
	41, // 34: pb.BulkLoadHFileRequest.region:type_name -> pb.RegionSpecifier
	35, // 35: pb.BulkLoadHFileRequest.family_path:type_name -> pb.BulkLoadHFileRequest.FamilyPath
	36, // 36: pb.CoprocessorServiceResult.value:type_name -> pb.NameBytesPair
	41, // 37: pb.CoprocessorServiceRequest.region:type_name -> pb.RegionSpecifier
	21, // 38: pb.CoprocessorServiceRequest.call:type_name -> pb.CoprocessorServiceCall
	41, // 39: pb.CoprocessorServiceResponse.region:type_name -> pb.RegionSpecifier
	36, // 40: pb.CoprocessorServiceResponse.value:type_name -> pb.NameBytesPair
	12, // 41: pb.Action.mutation:type_name -> pb.MutationProto
	7,  // 42: pb.Action.get:type_name -> pb.Get
	21, // 43: pb.Action.service_call:type_name -> pb.CoprocessorServiceCall
	41, // 44: pb.RegionAction.region:type_name -> pb.RegionSpecifier
	25, // 45: pb.RegionAction.action:type_name -> pb.Action
	41, // 46: pb.MultiRegionLoadStats.region:type_name -> pb.RegionSpecifier
	27, // 47: pb.MultiRegionLoadStats.stat:type_name -> pb.RegionLoadStats
	8,  // 48: pb.ResultOrException.result:type_name -> pb.Result
	36, // 49: pb.ResultOrException.exception:type_name -> pb.NameBytesPair
	22, // 50: pb.ResultOrException.service_result:type_name -> pb.CoprocessorServiceResult
	27, // 51: pb.ResultOrException.loadStats:type_name -> pb.RegionLoadStats
	29, // 52: pb.RegionActionResult.resultOrException:type_name -> pb.ResultOrException
	36, // 53: pb.RegionActionResult.exception:type_name -> pb.NameBytesPair
	26, // 54: pb.MultiRequest.regionAction:type_name -> pb.RegionAction
	11, // 55: pb.MultiRequest.condition:type_name -> pb.Condition
	30, // 56: pb.MultiResponse.regionActionResult:type_name -> pb.RegionActionResult
	28, // 57: pb.MultiResponse.regionStatistics:type_name -> pb.MultiRegionLoadStats
	34, // 58: pb.MutationProto.ColumnValue.qualifier_value:type_name -> pb.MutationProto.ColumnValue.QualifierValue
	3,  // 59: pb.MutationProto.ColumnValue.QualifierValue.delete_type:type_name -> pb.MutationProto.DeleteType
	9,  // 60: pb.ClientService.Get:input_type -> pb.GetRequest
	13, // 61: pb.ClientService.Mutate:input_type -> pb.MutateRequest
	16, // 62: pb.ClientService.Scan:input_type -> pb.ScanRequest
	19, // 63: pb.ClientService.BulkLoadHFile:input_type -> pb.BulkLoadHFileRequest
	23, // 64: pb.ClientService.ExecService:input_type -> pb.CoprocessorServiceRequest
	23, // 65: pb.ClientService.ExecRegionServerService:input_type -> pb.CoprocessorServiceRequest
	31, // 66: pb.ClientService.Multi:input_type -> pb.MultiRequest
	10, // 67: pb.ClientService.Get:output_type -> pb.GetResponse
	14, // 68: pb.ClientService.Mutate:output_type -> pb.MutateResponse
	17, // 69: pb.ClientService.Scan:output_type -> pb.ScanResponse
	20, // 70: pb.ClientService.BulkLoadHFile:output_type -> pb.BulkLoadHFileResponse
	24, // 71: pb.ClientService.ExecService:output_type -> pb.CoprocessorServiceResponse
	24, // 72: pb.ClientService.ExecRegionServerService:output_type -> pb.CoprocessorServiceResponse
	32, // 73: pb.ClientService.Multi:output_type -> pb.MultiResponse
